...
The setup process of Arduino IDE for NodeMCU is described in the following article 👉 [How to Setup Arduino IDE for NodeMCU?](https://tasnimzotder.com/posts/how-to-set-up-arduino-ide-for-nodemcu).
...
- "NodeMCU - Wikipedia" En, [https://en.wikipedia.org/wiki/NodeMCU](https://en.wikipedia.org/wiki/NodeMCU).
- "NodeMcu -- An open-source firmware based on ESP8266 wifi-soc." Nodemcu, [https://www.nodemcu.com/index_en.html](https://www.nodemcu.com/index_en.html).
- "NodeMCU ESP8266 Pinout, Specifications, Features & Datasheet" Components101, 22 Apr. 2020, [https://components101.com/development-boards/nodemcu-esp8266-pinout-features-and-datasheet](https://components101.com/development-boards/nodemcu-esp8266-pinout-features-and-datasheet).
- "UNO R3 | Arduino Documentation | Arduino Documentation" Docs, [https://docs.arduino.cc/hardware/uno-rev3](https://docs.arduino.cc/hardware/uno-rev3).
- "MicroPython - Python for microcontrollers" Micropython, [https://micropython.org/](https://micropython.org/).
- "NodeMCU Documentation" Nodemcu, [https://nodemcu.readthedocs.io/en/release/](https://nodemcu.readthedocs.io/en/release/).
